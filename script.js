...
const apps = {
    ...
    finora: {
        id: 'finora',
        icon: '💰',
        iconUrl: 'assets/images/finora-icon.png',
        name: 'Finora',
        tagline: {
        ...
        description: {
            fr: 'Finora est une application de gestion financière personnelle propulsée par l\'IA. Scannez vos reçus automatiquement, suivez vos dépenses par catégorie, définissez des budgets mensuels et atteignez vos objectifs d\'épargne. Disponible sans compte — vos données sont sauvegardées localement.',
            en: 'Finora is an AI-powered personal finance app. Automatically scan receipts, track expenses by category, set monthly budgets and reach your savings goals. Available without an account — your data is saved locally.',
        ...
        playStore: '#',
        screenshots: [
            'assets/images/finora-icon.png',
        ],
        privacy: 'finora-privacy.html',
        terms: 'finora-terms.html',
...
const translations = {
    fr: {
        ...
        timeline_finora_date: 'Avril 2026',
        timeline_finora_title: 'Lancement de Finora',
        timeline_finora_p: 'App de finance personnelle avec scanner de reçus IA et gestion de budget.',
        ...
        app_finora_tagline: 'Gérez vos dépenses avec l\'IA.',
    ...
    en: {
        ...
        timeline_finora_date: 'April 2026',
        timeline_finora_title: 'Launching Finora',
        timeline_finora_p: 'Personal finance app with AI receipt scanner and smart budget management.',
        ...
        app_finora_tagline: 'Track your spending with AI.',
    ...
    ar: {
        ...
        timeline_finora_date: 'أبريل 2026',
        timeline_finora_title: 'إطلاق Finora',
        timeline_finora_p: 'تطبيق مالية شخصية مع ماسح فواتير ذكي وإدارة الميزانية.',
        ...
        app_finora_tagline: 'تتبع مصاريفك بالذكاء الاصطناعي.',
